...
COLLECTION_NAME_GRINDER = 'grinder'
COLLECTION_NAME_GRINDERTASK = 'grindertask'
COLLECTION_NAME_PUBLICATION = 'publication'
COLLECTION_NAME_SNIPPET_HEADER = 'snippetheader'
COLLECTION_NAME_SNIPPET = 'snippet'

NOTEBOOK_TITLE_SHELF = 'Shelf'
NOTEBOOK_TITLE_GRINDER = 'Grinder'
NOTEBOOK_TITLE_SNIPPET = 'Snippet'
